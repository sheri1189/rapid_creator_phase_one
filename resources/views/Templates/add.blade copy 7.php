    ...
    <div class="app-main flex-column flex-row-fluid " id="kt_app_main">
        <div class="d-flex flex-column flex-column-fluid">
            ...
            <div id="kt_app_footer" class="app-footer ">
                <div class="app-container  container-fluid d-flex flex-column flex-md-row flex-end flex-md-stack py-3 ">
                    <div class="text-gray-900 order-2 order-md-1">
                        <span class="text-muted fw-semibold me-1">
                            {{ date('Y') }}©</span>
                        <a href="https://ibextack.com/live/" target="_blank"
                            class="text-gray-800 text-hover-primary">ibexstack</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            $.ajax({
                ...
                error: function(error) {
                    Swal.fire({
                        toast: true,
                        icon: 'success',
                        title: 'Error processing screenshot data. Please try again later.',
                        animation: false,
                        position: 'top-right',
                        showConfirmButton: false,
                        timer: 3000,
