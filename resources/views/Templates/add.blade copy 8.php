            ...
            <div id="kt_app_content" class="app-content  flex-column-fluid ">
                <div id="kt_app_content_container" class="app-container  container-xxl">
                    <div class="row d-flex">
                        ...
                        <div class="col-lg-6 col-xl-6 col-md-6" style="display: none" id="image_processing">
                            <div class="card custom-card mx-auto" style="width: 502px;height:519px;">
                                <div class="card-header">
                                    ...
                                    {{--                                    <span class="fw-bold text-danger bg-light-info text-center fs-7 mb-5">Note: Make Sure that You Will be Make the Image within the Text On the Single Line !</span>--}}
                                </div>
                        ...
                        {{--                        <div class="col-lg-6 col-xl-6 col-md-6" id="getting_preview" style="text-align: -webkit-center">--}}
                        {{--                            <div class="card custom-card bg-dark" style="width: 502px;height:502px">--}}
                        {{--                                <div class="card-body pt-9 pb-0" style="background-color: #2d3250;width:500px;height:454px">--}}
                        {{--                                    <div id="capture_preview" class="bg-dark">--}}
                        {{--                                        <div id="container" class="ui-widget-content">--}}
                        {{--                                            <div id="input">Text Here</div>--}}
                        {{--                                        </div>--}}
...
@section('script')
    ...
    <script>
        ...
        function onChange(e) {
            ...
            while (fontSize > MIN_FONT_SIZE && (el.scrollHeight > maxHeight || el.scrollWidth > maxWidth)) {
                fontSize--;
                el.style.fontSize = fontSize + 'px';
            }
            if (el.scrollHeight > maxHeight) {
                ...
                container.resizable("option", "disabled", false);
            }
        }
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if (response.message == 200) {
                            ...
                            $("#selectFontVariants").val($("#selectFontVariants option:first").val());
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.message === 200) {
                        ...
                        $("#details").attr("href", "{{url('template')}}");
                        $("#edit").val(response.template);
                        Swal.fire({
                            toast: true,
                            icon: 'success',
                            title: 'Template Created Succcessfully !',
                            animation: false,
                            position: 'top-right',
                            showConfirmButton: false,
                            timer: 3000,
                        ...
                        Swal.fire({
                            toast: true,
                            icon: 'error',
                            title: 'Template not Created Succcessfully !',
                            animation: false,
                            position: 'top-right',
                            showConfirmButton: false,
                            timer: 3000,
