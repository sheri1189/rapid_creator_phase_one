...
<div class="d-flex flex-column flex-root" id="kt_app_root">
    ...
    border-radius: 8px;"/>
                            ...
                            <div style="margin-bottom: 15px">
                                <img alt="Logo" src="{{$message->embed('assets/media/email/icon-positive-vote-1.png')}}"/>
                            </div>
                            <div style="font-size: 14px; font-weight: 500; margin-bottom: 27px; font-family:Arial,Helvetica,sans-serif;">
                                <p style="margin-bottom:9px; color:#181C32; font-size: 22px; font-weight:700">Hey {{$name}}</p>
                                <p style="margin-bottom:2px; color:#7E8299;font-weight: bold">{{$getMessage}}</p>
                                <p style="margin-bottom:2px; color:#7E8299">{{__("If You Have any Query Then Contact To Admin")}}</p>
                                <p style="margin-bottom:2px; color:#7E8299">{{__($adminEmail)}}</p>
                            </div>
                        </div>
                    </td>
                </tr>
